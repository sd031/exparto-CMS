...
<?php else: ?>
	...
	<tr><th  class="no-items-row" colspan="3"><?php echo Yii::t('backend', 'NO_ACTIONS_FOUND'); ?></th></tr>
...
<?php if( $items['modules']!==array() ): ?>
	...
	<?php if( $displayModuleHeadingRow===true ): ?>
		...
		<tr><th class="module-heading-row" colspan="3"><?php echo Yii::t('backend', 'STR_MODULES'); ?></th></tr>

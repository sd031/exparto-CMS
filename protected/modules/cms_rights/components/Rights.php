...
class Rights
{
	...
	*/
	...
	{
		return array(
			CAuthItem::TYPE_OPERATION=>Yii::t('backend', 'STR_OPERATION'),
			CAuthItem::TYPE_TASK=>Yii::t('backend', 'STR_TASK'),
			CAuthItem::TYPE_ROLE=>Yii::t('backend', 'STR_ROLE'),
		);
	}
	...
	*/
	public static function getAuthItemTypeNamePlural($type)
	{
		switch( (int)$type )
		{
			case CAuthItem::TYPE_OPERATION: return Yii::t('backend', 'STR_OPERATION');
			case CAuthItem::TYPE_TASK: return Yii::t('backend', 'STR_TASKS');
			case CAuthItem::TYPE_ROLE: return Yii::t('backend', 'STR_ROLES');
			default: throw new CException(Yii::t('backend', 'STR_INVALID_AUTHORIZATION_ITEM_TYPE'));
		}
	}
	...
	*/
	private static function findModule(CModule $module=null)
	{
		...
		if( ($m = $module->getModule('cms_rights'))!==null )
			return $m;

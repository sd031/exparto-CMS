...
class AuditTrail extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'old_value' => Yii::t('backend', 'STR_OLD_VALUE'),
			'new_value' => Yii::t('backend', 'STR_NEW_VALUE'),
			'action' => Yii::t('backend', 'STR_ACTION'),
			'model' => Yii::t('backend', 'STR_MODEL'),
			'field' => Yii::t('backend', 'STR_FIELD'),
			'stamp' => Yii::t('backend', 'STR_STAMP'),
			'user_id' => Yii::t('backend', 'STR_USER_ID'),
			'model_id' => Yii::t('backend', 'STR_MODEL_ID'),
		);
	}

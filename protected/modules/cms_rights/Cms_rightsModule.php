...
* ),
*/
class Cms_rightsModule extends CWebModule
{

  public $name='Rights';
  public $description='Rights module';
  ...
  public $is_core=false;
	...
	*/
	public $baseUrl = '/cms_rights/admin/assignment/index';
	/**
	* @property string the path to the layout file to use for displaying Rights.
	*/
	public $layout = 'cms_rights.views.layouts.main';
	/**
	* @property string the path to the application layout file.
	*/
	public $appLayout = 'cms_core.views.layouts.backend';
	/**
  ...
  {
    return array( 
                array('label'=>Yii::t('backend','STR_USERS'), 'url'=>array('/cms_cmsuser/admin/default/index'), 'sort_order'=>'21', 'items'=>array(
                    array('label'=>Yii::t('backend','STR_RIGHTS'), 'url'=>array('/cms_rights/admin/assignment/view')),
                )),                             
    ); 
	...
	*/
    ...
    CmsModule::initCore($this);
		...
		$this->setImport(array(
			'cms_rights.components.*',
			'cms_rights.components.behaviors.*',
			'cms_rights.components.dataproviders.*',
			'cms_rights.controllers.*',
			'cms_rights.models.*',
		));
	...
	*/
	public function getAssetsUrl()
	{
		...
		{
			$assetsPath = Yii::getPathOfAlias('cms_rights.assets');

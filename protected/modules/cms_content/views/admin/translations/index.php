...
<div class="column-content-box">
  <div class="content-box content-box-header ui-corner-all">
    ...
    <?php endif?>  
      ...
      <a class="ui-state-default float-left ui-corner-all ui-button" href="<?php echo $this->createUrl('/cms_content/admin/language/index');?>" >
    ...
    <br />
    <?php endif;?>      
    <h2><?php echo Yii::t('backend', 'STR_SITE_TRANSLATIONS');?></h2> 
    <?php if($langs):?>     	
    <h5 style="margin-bottom:5px"><?php echo Yii::t('backend','STR_COMPARE_TRANSLATION_WITH_OTHER_LANGUAGE'); ?></h5> 
     <?php echo CHtml::dropDownList('language','',array(''=>'-')+CmsLanguage::getOptions(),array('class'=>'field select small','style'=>'width:150px;','id'=>'comp-sel')); ?>    
    <div style="clear:both"></div>
    <br />
    ...
    <?php if($langs):?>
      ...
      <?php echo CHtml::hiddenField('language',$langs[0]->lang_code,array('id'=>'trans_lang')); ?>
      <div style="clear:both"></div>    
      <ul>
        <li class="buttons">

...
<div class="column-content-box">
  <div class="content-box content-box-header ui-corner-all">
    ...
    <a class="ui-state-default float-left ui-corner-all ui-button" href="<?php echo $this->createUrl('filebackup');?>" style="margin-left:0">
    ...
    $this->widget('zii.widgets.grid.CGridView', array(
      ...
      'cssFile'=>$this->cssDir.'/gridview.css',	  
    	'columns' => array(
          ...
          'deleteButtonUrl'=>'Yii::app()->controller->createUrl("fileDelete",array("file"=>$data["filename"]))',
